...
class Clevis_Zend_Doctrine_DoctrineException extends Zend_Exception
{
     ...
     * @return Clevis_Zend_Doctrine_DoctrineException
     */
    ...
    static public function libraryPathMissing()
    {
        return new self("To use the ZEND_SINGLE_LIBRARY model loading mode you have to specify ".
            "a library path using Clevis_Zend_Doctrine_Core::setSingleLibraryPath()");
    }
