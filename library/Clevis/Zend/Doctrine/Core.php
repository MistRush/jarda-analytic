 ...
 */
class Clevis_Zend_Doctrine_Core extends Doctrine_Core
{
    /**
     * @var int
     */
    ...
    static public function setSingleLibraryPath($path)
    {
        if (!file_exists($path) || !is_dir($path)) {
            throw Clevis_Zend_Doctrine_DoctrineException::invalidLibraryPath($path);
        }
        ...
        if (self::$_modelDirs == null) {
            ...
            if ($modelLoading == self::MODEL_LOADING_ZEND) {
                ...
                if (!self::$_singleLibraryPath) {
                    throw Clevis_Zend_Doctrine_DoctrineException::libraryPathMissing();
                }
                ...
                throw Clevis_Zend_Doctrine_DoctrineException::invalidZendStyle();
            }
