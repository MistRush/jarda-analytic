 ...
 */
class Clevis_Zend_Doctrine_Form_Model extends Zend_Form
{
    ...
    /**
     *
     * @var Clevis_Zend_Doctrine_Form_Model_Adapter_Interface
     */
    ...
    public function __construct($options = null) {
        ...
        if($this->_model == '') {
            throw new Clevis_Zend_Doctrine_DoctrineException('No model defined for form generation');
        }
        if($this->_adapter == null) {
            $this->setAdapter(new Clevis_Zend_Doctrine_Form_Model_Adapter_Doctrine());
        }
    ...
    /**
     * @return Clevis_Zend_Doctrine_Form_Model_Adapter_Interface
     */
    public function getAdapter() {
        return $this->_adapter;
    }

    public function setAdapter(Clevis_Zend_Doctrine_Form_Model_Adapter_Interface $adapter) {
    ...
    public function save($persist = true) {
        ...
        foreach($this->getSubForms() as $subForm) {
            if ($subForm instanceof Clevis_Zend_Doctrine_Form_ModelSubForm) {
