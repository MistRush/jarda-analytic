...
class Clevis_Zend_Doctrine_Application_Resource_Doctrine extends Zend_Application_Resource_ResourceAbstract
{
    /**
     * @var array
     */
    ...
    {
        $reflect = new ReflectionClass('Clevis_Zend_Doctrine_Core');
     ...
     *
     * @param   array $options
     * @return  Clevis_Zend_Doctrine_Application_Resource_Doctrine
     */
    ...
    protected function _initManager()
    {
        ...
        $manager->setAttribute(Doctrine_Core::ATTR_MODEL_LOADING, Clevis_Zend_Doctrine_Core::MODEL_LOADING_ZEND); // default
    ...
    public function init()
    {
        if (!class_exists('Doctrine_Core')) {
            throw Clevis_Zend_Doctrine_DoctrineException::doctrineNotFound();
        }
        ...
        return new Clevis_Zend_Doctrine_Registry($manager, $connections, $this->_paths, $this->_generateModelOptions);
    }
}
