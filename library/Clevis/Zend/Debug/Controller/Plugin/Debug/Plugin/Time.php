 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class Clevis_Zend_Debug_Controller_Plugin_Debug_Plugin_Time extends Zend_Controller_Plugin_Abstract implements Clevis_Zend_Debug_Controller_Plugin_Debug_Plugin_Interface
{
    /**
    ...
    public function getPanel()
    {
        ...
        $timerNamespace = new Zend_Session_Namespace('Clevis_Zend_Debug_Time',false);
        ...
        $html .= '<br />Reset timers by sending Clevis_Zend_Debug_RESET as a GET/POST parameter';
    ...
    {
        $reset = Zend_Controller_Front::getInstance()->getRequest()->getParam('Clevis_Zend_Debug_RESET');
        if (isset($reset)) {
            $timerNamespace = new Zend_Session_Namespace('Clevis_Zend_Debug_Time',false);
