 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class Clevis_Zend_Debug_Controller_Plugin_Debug_Plugin_Auth implements Clevis_Zend_Debug_Controller_Plugin_Debug_Plugin_Interface
{
    /**
    ...
    /**
     * Create Clevis_Zend_Debug_Controller_Plugin_Debug_Plugin_Auth
     *
     * @var string $user
     * @var string $role
     * @return void
