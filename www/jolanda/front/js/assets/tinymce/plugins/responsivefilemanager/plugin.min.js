...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	function openmanager() {
        ...
        if (typeof editor.settings.filemanager_relative_url !== "undefined" && editor.settings.filemanager_relative_url) {
            basePath="&basePath="+editor.settings.filemanager_relative_url;
        }
		var crossdomain="";
		...
		const fileUrl = editor.settings.external_filemanager_path+'dialog.php?type=4&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&akey='+akey+basePath+fldr;
