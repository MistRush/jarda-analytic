class QuickEditor extends EntityEditor{
    ...
    confirm() {
        ...
        if (typeof this.onBeforeConfirm == "function") {
            let result = this.onBeforeConfirm()
        ...
        if (this.form.validate()) {
            ...
            Promise.all(filePromises).then((data) => {
                ...
                Helpers.ajax({
                    type: 'POST',
                    url: (this.entity_id == null || this.entity_id == '') ? this.datacreateUrl : this.dataupdateUrl,
                    data: {
