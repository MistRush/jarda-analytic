...
class Kanban {
    protected int|string|null $initPanel = null;
    ...
    public function initPanel(int|string|null $panelId): void {
...
<div 
    id="__kanban__vue__"
    data-init-panel="{$this->getInitPanel()}"
...
HTML;
    ...
    public function getInitPanel($json = true): array|string {
        return $json ? htmlspecialchars(json_encode($this->initPanel), ENT_QUOTES, 'UTF-8') : $this->initPanel;
    }
