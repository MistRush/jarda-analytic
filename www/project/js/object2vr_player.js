...
function oc(A) {
    if (A) {
        ...
        z = U[m];
        A = A(z);
        A != z && null != A && mc(U, m, {configurable: !0, writable: !0, value: A})
    }
}
...
function object2vrPlayer(A) {
    function U() {
        ...
        K.innerHTML = pc("");
        var a =
    ...
    function z() {
        ...
        if (!c.isLoaded && c.hasConfig) {
            for (a = e = 0; a < c.checkLoaded.length; a++) c.checkLoaded[a].complete && "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAIAAABLbSncAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAA5JREFUeNpiYBgeACDAAADIAAE3iTbkAAAAAElFTkSuQmCC" != c.checkLoaded[a].src && e++;
            Gb && (Gb = !1);
        ...
        if (0 < h.mode) {
            if (2 == h.mode) for (a = 0; a < G.length; a++) e = G[a], "poly" == e.hstype && e.m != e.f && (e.m > e.f ? (e.f += h.ba, e.m < e.f && (e.f = e.m)) : (e.f -= h.ba, e.m > e.f && (e.f = e.m)), c.a = !0);
    ...
    function sb(a, e) {
        ...
        for (var c = 0; c < G.length; c++) {
            var y = G[c];
            if ("poly" == y.hstype && y.T && 0 <= h.mode) for (var tb = 0; tb < y.T.length; tb++) {
                var k = y.T[tb];
                if ((k.fa == f.I || y.reuse & 1) && (k.ga == f.J || y.reuse & 2) && (k.state == f.K || y.reuse & 4)) for (var l = 0; l < k.Y.length; l++) {
                    var p = k.Y[l];
                    if (0 < p.F.length) {
                        var na;
                        var u = !1;
        ...
        if (c.s &&
            ...
            if (J) {
                ...
                for (var e = 0; e < G.length; e++) {
                    var b = G[e];
                    if ("poly" == b.hstype) for (var g = 0; g < b.T.length; g++) {
                        var y = b.T[g];
                        if ((y.fa == f.I || b.reuse & 1) && (y.ga == f.J || b.reuse & 2) && (y.state == f.K || b.reuse & 4)) for (var k = 0; k < y.Y.length; k++) {
                            var l = y.Y[k];
                            2 == h.mode &&
                            (a = b.f);
    ...
    function tc(a) {
        if (!L) {
            ...
            var e = (new Date).getTime(), b = -1;
            b = Math.abs(Tb - Ca) + Math.abs(Ub - Da);
            if (0 <= b && 20 > b && ba(a.target)) {
                var f = !1;
                if (c.D) for (b = c.D; b && b != c.control;) b.onclick && !f && (b.onclick(), f = !0), b = b.parentNode;
    ...
    function uc(a) {
        ...
        if (!L) {
            if (1 == e.length && e[0] && (Ca = e[0].pageX, Da = e[0].pageY, 0 <= r)) {
                a.preventDefault();
                for (b = 0; b < e.length; b++) if (Math.abs(e[b].identifier) == r) {
                    var f = e[b].pageY;
                    Ta = e[b].pageX;
                    Ua = f;
                    V = Ta;
            ...
            if (1 == e.length && 0 > r && e[0]) {
                ...
                if (c.D) {
                    ...
                    for (flag = !1; b && !ba(b);) {
                        ...
                        b.onmousedown && !flag && (b.onmousedown(), flag =
                            !0);
                        b = b.parentNode
                    }
    ...
    function Ea(a) {
        if (!Zb && (a = a ? a : window.event, a = Fa(a), ba(a.target))) {
            ...
            $b && (e = -e);
            if (0 != e) {
                var b = c.mouse.x - H - .5 * D, f = c.mouse.y - I - .5 * E, y = n;
            ...
            if (ya = !1, 0 <= f.I && 0 <= f.J) {
                ...
                if (0 < f.l.length) {
                    ...
                    for (var k = y, l = !1; !l;) {
                        ...
                        var z = (-a + D) / b * (p.width / f.u), A = (-e + E) / g * (p.height / f.u);
                        ...
                        for (h = m; h <= A; h++) for (m = q; m <= z; m++) {
                            var F = m + h * p.M, r = p.N[F];
                    ...
                    for (; k >= y;) {
                        ...
                        z = Math.min(Math.max(0, Math.floor(z)), p.M - 1);
                        A = Math.min(Math.max(0, Math.floor(A)), p.aa - 1);
                        for (h = m; h <= A; h++) for (m = q; m <= z; m++) F = m + h * p.M, (r = p.N[F]) || (r = p.N[F] = {}), !r.i && 5 > ha && (r.i = new Image, r.i.setAttribute("src", ub(f.I, f.J, f.K, k, m, h)), r.i.onload = xc, r.i.onerror = gc, r.i.onabort = gc, 0 == ha && c.divSkin && c.divSkin.ggReLoadedLevels && c.divSkin.ggReLoadedLevels(), ha++),
                ...
                if (ya) for (a = 0; a < G.length; a++) if (e = G[a], "point" == e.hstype) {
                    y = !1;
    ...
    function $a() {
        c.isFullscreen && (Wa() || c.exitFullscreen(), Wa() && (c.b.style.left =
            "0px", c.b.style.top = "0px"))
    }
    ...
    var R =
            0, D = 320, E = 480, n = 1, Cb = 1, Qa = 1, Ra = 1, Ha = -1, B = 0, C = 0, Ya = 0, Za = 0, t = 1, fc = 1, Yb,
        ta, Xb, gb = 0, hb = 0, V = 0, W = 0, cc = 0, dc = 0, Ta = 0, Ua = 0, r = -1, Tb = 0, Ub = 0, Ca = 0, Da = 0,
        Vb = 0, Wb = 0, Va, nb = !0, lb = 0, mb = 0, Y = 0, Z = 0, Fb = !1, k = {
            enabled: !1,
            A: 0,
            ca: 0,
            v: {enabled: !0, width: 180, height: 20, U: 0, background: !0, B: 16777215, C: 0, R: 1, S: 1, wordwrap: !0},
            V: []
        }, G = [];
    c.emptyHotspot = {
        pan: 0,
    ...
    c.mouse = {x: 0, y: 0};
    var ja = 0, F = null, P = null, u = null, M = null, ka = null, x = null,
        T = null, ca = null, qa = null, O = null, fa = null, oa = null, l = null;
    c.control = null;
    c.checkLoaded = [];
    c.isFullscreen = !1;
    c.divSkin = null;
    c.isLoaded = !1;
    c.hasConfig = !1;
    var ob = 0, Gb = !1, ma = !1, Ja = 5, ea = !1, la = .4, rb = !1, sa = !1, xa = .1, va = 0, wa = 0, da = 0, pb, Hb,
        Ib, qb;
    c.skinObj = null;
    c.a = !1;
    var Ab = c.O = !1;
    ...
    var H = 0, I = 0, cb = 0, db = 0, fb = 3, Ba = !1, L = !1, Zb = !1, wb = !0, aa = !1, $b = !1, ac = 1, yb = !0,
        Lb = !1, Mb = !1, jb = !1, kb = !1, X = !1, ra = 10, f = {
            x: 0,
            y: 0,
            g: 0,
            o: 0,
        ...
        }, ic = !0, jc = 0, N = "", Ia = "transition", xb = !1, Bb = "", h = {
            mode: 1,
            f: 0,
            m: 0,
            ba: .05,
        ...
        }, kc = navigator.userAgent.toLowerCase(), ab = -1 != kc.indexOf("msie") ? parseInt(kc.split("msie")[1]) : !1,
        zc = navigator.userAgent.match(/(iPad|iPhone|iPod)/g) ?
            !0 : !1, Db = !1, Eb = function () {
    ...
    c.updateObject = function () {
        Aa();
        var a = Math.floor(f.x), e = Math.floor(f.y), b = f.state, g = !1;
        if (f.I != a || f.J != e || f.K != b) {
            if (0 < f.l.length) for (g = 0; g < f.l.length; g++) {
                var h = f.l[g];
                h.cache ?
                    h.ha[f.ia()] = h.N : h.N = []
            }
            ...
            f.J = e;
            f.K = b;
            if (0 < f.l.length && ca) for (g = 0; g < f.l.length; g++) h = f.l[g], h.cache && (h.N = h.ha[f.ia()], h.N || (h.N = [])); else 0 < f.l.length ? ka.setAttribute("src", ub(a, e, b, f.l.length - 1, 0, 0)) : ka.setAttribute("src", vb(a, e, b)), ka.onload = function () {
                this.na = !0;
                c.a = !0;
                c.O = !0
            }, ka.na = !1;
    ...
    c.preloadImages = function () {
        ...
        if (0 < f.l.length) for (g = 0; g < f.l.length; g++) {
            var h = f.l[g];
            if (h.cache) for (b = 0; b < f.L; b++) for (e = 0; e < f.j; e++) for (a = 0; a < f.c; a++) {
                var k = [], l, n;
                for (n = 0; n < h.aa; n++) for (l = 0; l < h.M; l++) {
                    var p = l + n * h.M;
                    var m = {};
                    m.i =
                        new Image;
        ...
        } else if (f.ka) for (g = new Image, g.src = vb(f.Z, f.$, f.da), b = 0; b < f.L; b++) for (e = 0; e < f.j; e++) for (a = 0; a < f.c; a++) g = new Image, g.src = vb(a, e, b), c.checkLoaded.push(g)
    };
    var J;
    Ka = function (a, e) {
        var b = h.v;
    ...
    c.ma = function () {
        for (var a = 0; a < G.length; a++) if ("point" == G[a].hstype &&
    ...
    c.assignHandler = function () {
        ...
        a.oncontextmenu = function (a) {
            void 0 ===
            a && (a = window.event);
            return a.ctrlKey || (a = "<<L>>" + String(a.target), a = a.toUpperCase(), "U" == a.charAt(2)) ? !0 : (U(), !1)
        }
    };
    c.setFullscreen = function (a) {
        ...
        if (c.isFullscreen) {
            ...
            document.body.style.overflow = "";
            c.divSkin &&
            c.divSkin.ggExitFullscreen && c.divSkin.ggExitFullscreen()
        }
        ua()
    };
    ...
    c.readConfigXml = function (a) {
        ...
        for (var b; a;) {
            if ("view" == a.nodeName) for (e = a.firstChild; e;) "start" == e.nodeName && (b = e.getAttributeNode("column"), f.Z = Number(b ? b.nodeValue : 0), f.x = f.Z, b = e.getAttributeNode("row"), f.$ = Number(b ? b.nodeValue : 0), f.y = f.$, b = e.getAttributeNode("state"), f.da = Number(b ? b.nodeValue : 0), f.state = f.da), "zoom" ==
            ...
            if ("input" == a.nodeName) {
                ...
                if (b = a.getAttributeNode("rows")) f.j =
                    1 * b.nodeValue;
                ...
                if (b = a.getAttributeNode("preload")) f.ka =
                    1 == b.nodeValue;
                f.l = [];
            ...
            if ("hotspots" ==
                a.nodeName) for (e = a.firstChild; e;) {
                if ("label" == e.nodeName) {
                    g = h.v;
                ...
                if ("polystyle" == e.nodeName) {
                    ...
                    if (b =
                        e.getAttributeNode("borderalpha")) h.H = 1 * b.nodeValue;
                ...
                if ("hotspot" == e.nodeName) {
                    ...
                    if (b =
                        e.getAttributeNode("reuse")) g.reuse = b.nodeValue;
