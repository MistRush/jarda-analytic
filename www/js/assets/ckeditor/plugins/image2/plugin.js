...
( function() {
	...
	function widgetDef( editor ) {
		...
		return {
			...
			styleableElements: 'div img figure a',
			...
			init: function() {
				...
				if(data.width && this.parts.caption) {
					// this.parts.caption.getAscendant('figure').$.setAttribute('style', 'max-width:'+data.width +'px');
					this.parts.caption.$.setAttribute('style', 'max-width:'+data.width +'px');
				}
		...
		var alignClasses = editor.config.image2_alignClasses,
			rules = {
				...
				div: {
					...
					attributes: 'href,style,target'
				},
				p: {
					match: centerWrapperChecker( editor )
				},
				a: {
					classes: 'simple-button-plugin',
					attributes: 'href,style,target'
				},
				img: {
