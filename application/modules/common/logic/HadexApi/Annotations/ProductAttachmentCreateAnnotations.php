...
class ProductAttachmentCreateAnnotations {
    /**
     * @OA\Post(
     ...
     *     @OA\RequestBody(
     *         description="Povinné údaje pro vytvoření přílohy jsou buď productId nebo productCode, hash, attachmentType, urlPath nebo attachmentDataAsBase64",
     *         required=true,
     *         @OA\JsonContent(
     *             type="array",
     *              @OA\Items(
     *     required={"productId", "productCode", "attachmentType", "urlPath", "hash"},
     *             @OA\Property(property="productId", type="integer", example=22, description="ID produktu"),
     *             @OA\Property(property="productCode", type="string", example="neco", description="Kód produktu"),
     ...
     *                 type="string",
     *                 enum={"OBR1", "OBR2", "OBR3", "OBR4", "NAVOD", "MANUAL", "SPEC", "PROHL", "CERT", "SOFT1", "SOFT2", "SOFT3", "SOFT4", "SOFT5", "SOFT6", "SOFT7", "SOFT8", "SOFT9", "CATEGORY"},
     *                 example="OBR1",
     ...
     *             type="array",
     *             @OA\Items(
     *                 @OA\Property(property="id", type="integer", example=0, description="ID přílohy"),
     *                 @OA\Property(property="productId", type="integer", example=22, description="ID produktu"),
     *                 @OA\Property(property="productCode", type="string", example="neco", description="Kód produktu"),
     *                 @OA\Property(property="fileName", type="string", example="_67kabelspojky.jpg", description="Název souboru"),
     *                 @OA\Property(property="urlPath", type="string", example="", description="URL cesta k souboru"),
