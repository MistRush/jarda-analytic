...
/**
 * @OA\Schema(
 *      schema="ProductAttachment",
 *      type="object"
 * )
 */
class ProductAttachment {
    /**
     *     required={"id", "productId", "fileName", "urlPath", "hash", "alt", "attachmentType", "attachmentDataAsBase64"},
     *     @OA\Property(
     *         property="id",
     *         type="integer",
     ...
     *         type="string",
     *         description="Typ přílohy (např. obrázek, dokument)"
     *     )
     */
    public function getProductAttachmentSchema() {}
}