...
class ShippingMethodCreateAnnotations {
    /**
     * @OA\Post(
     *     path="/hadex-api/shipping-method",
     *     summary="Create a new shipping method",
     *     description="Creates a new shipping method with the provided details.",
    ...
    *),
     ...
     *             @OA\Property(property="message", type="string", example="Missing required fields: externalId, name")
     *         )
     *     )
     * )
     */
    ...
    public function getShippingMethodCreateAnnotations() {}
}