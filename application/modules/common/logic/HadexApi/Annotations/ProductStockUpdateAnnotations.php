...
class ProductStockUpdateAnnotations {
    /**
     * @OA\Put(
     *     path="/hadex-api/product-stock",
     *     summary="Update product stock",
     *     description="Updates stock information for one or more products. Either productId or productCode is required, along with warehouseCode and value.",
     *     tags={"Product Stock"},
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
    ...
    public function getProductStockUpdateAnnotations() {}
}