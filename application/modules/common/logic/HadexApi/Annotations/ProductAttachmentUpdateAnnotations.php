...
class ProductAttachmentUpdateAnnotations {
    /**
     * @OA\Put(
     *     path="/hadex-api/product-attachment",
     *     summary="Aktualizace přílohy produktu",
     *     description="Tato metoda slouží k aktualizaci existující přílohy produktu. Autorizace probíhá přes Bearer token.",
     ...
     *             @OA\Property(property="attachmentType", type="string", example="pdf", description="Typ přílohy (např. pdf, jpg)")
     *         )
     *      )
     *     ),
     *     @OA\Response(
